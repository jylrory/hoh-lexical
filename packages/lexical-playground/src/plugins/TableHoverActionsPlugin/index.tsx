...
function TableHoverActionsContainer({
  ...
  return (
    <>
      {isShownRow && (
        <button
          className={'hoh-theme__tableAddRows'}
          style={{ ...position }}
      ...
      {isShownColumn && (
        <button
          className={'hoh-theme__tableAddColumns'}
          style={{ ...position }}
...
function getMouseInfo(event: MouseEvent): {
  ...
  if (target && target instanceof HTMLElement) {
    const tableDOMNode = target.closest<HTMLElement>(
      'td.hoh-theme__tableCell, th.hoh-theme__tableCell',
    )

    const isOutside = !(
      tableDOMNode ||
      target.closest<HTMLElement>('button.hoh-theme__tableAddRows') ||
      target.closest<HTMLElement>('button.hoh-theme__tableAddColumns') ||
